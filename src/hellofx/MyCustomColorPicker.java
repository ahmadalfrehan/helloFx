...
public class MyCustomColorPicker extends VBox {
    ...
    public MyCustomColorPicker() {
        ...
        // colorRectOverlayOne.setBackground(new
        ...
        EventHandler<MouseDragEvent> rectMouseHandler = event -> {
        ...
        // CornerRadii.EMPTY, Insets.EMPTY)));
        colorRectOverlayTwo.setOnMouseDragReleased(rectMouseHandler);
        colorRectOverlayTwo.setOnMouseDragReleased(rectMouseHandler);
    ...
    private static LinearGradient createHueGradient() {
        ...
        return new LinearGradient(0f, 0f, 1f, 0f, false, null, stops);
        // (0f, 0f, 1f, 0f, true, CycleMethod.NO_CYCLE, stops);
    }
